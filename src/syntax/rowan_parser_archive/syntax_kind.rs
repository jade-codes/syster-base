...
pub enum SyntaxKind {
    ...
    COLON_EQ,           // :=  (initial value assignment)
    DOT,                // .
    DOT_DOT,            // ..
    COMMA,              // ,
    EQ,                 // =
    ...
    VARIATION_KW,
    VARIANT_KW,
    VAR_KW,  // variable feature marker
    ...
    // Trigger keywords (for accept/transition)
    AFTER_KW,
    WHEN_KW,
    AT_KW,
    ...
    FEATURING,
    CONJUGATION,
    RELATIONSHIP,  // Standalone relationship declaration
