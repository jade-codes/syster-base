...
pub enum LogosToken {
    ...
    // Scientific notation: must come before plain Integer to match first
    // Supports: 1E10, 1.5E10, 1E-10, 1.5E+10
    ...
    // Trigger keywords (must come after longer keywords that share prefixes)
    #[token("after")]
    AfterKw,
    #[token("at")]
    AtKw,
...
impl From<LogosToken> for SyntaxKind {
    fn from(token: LogosToken) -> Self {
        ...
        match token {
            ...
            Decimal | DecimalNoExponent => SyntaxKind::DECIMAL,
            ...
            ConjugateKw => SyntaxKind::CONJUGATE_KW,
            ConjugatesKw => SyntaxKind::CONJUGATES_KW,
            ConjugationKw => SyntaxKind::CONJUGATION_KW,
            ...
            DifferencesKw => SyntaxKind::DIFFERENCES_KW,
            ...
            FeaturedKw => SyntaxKind::FEATURED_KW,
            FeaturingKw => SyntaxKind::FEATURING_KW,
            ...
            InvertingKw => SyntaxKind::INVERTING_KW,
            ...
            MultiplicityKw => SyntaxKind::MULTIPLICITY_KW,
            MetadataKw => SyntaxKind::METADATA_KW,
            NamespaceKw => SyntaxKind::NAMESPACE_KW,
            ...
            RedefinitionKw => SyntaxKind::REDEFINITION_KW,
            ...
            SpecializationKw => SyntaxKind::SPECIALIZATION_KW,
