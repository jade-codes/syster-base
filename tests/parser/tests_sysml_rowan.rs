//! SysML parser tests adapted from Pest to Rowan
//!
...
use rstest::rstest;
use syster::parser::rule_parser::{self, parse_rule};
...
pub enum Rule {
    ...
    port_usage_keyword,
    connection_keyword,
    connection_def_keyword,
    connection_usage_keyword,
    connector_keyword,
    interface_keyword,
    interface_def_keyword,
    interface_usage_keyword,
    flow_keyword,
    flow_def_keyword,
    message_keyword,
    action_keyword,
    action_def_keyword,
    action_usage_keyword,
    state_keyword,
    state_def_keyword,
    state_usage_keyword,
    calculation_keyword,
    calculation_def_keyword,
    calculation_usage_keyword,
    constraint_keyword,
    constraint_def_keyword,
    constraint_usage_keyword,
    requirement_keyword,
    requirement_def_keyword,
    concern_keyword,
    concern_def_keyword,
    concern_usage_keyword,
    case_keyword,
    case_def_keyword,
    case_usage_keyword,
    analysis_keyword,
    verification_keyword,
    use_case_def_keyword,
    view_keyword,
    view_def_keyword,
    view_usage_keyword,
    viewpoint_keyword,
    viewpoint_def_keyword,
    viewpoint_usage_keyword,
    rendering_token,
    rendering_def,
    binding_keyword,
    succession_keyword,
    occurrence_keyword,
    occurrence_def_keyword,
    occurrence_usage_keyword,
    individual_marker,
    variation_token,
    constant_token,
    derived_token,
    ...
    // KerML Relationships (used in some SysML tests)
    specialization,
    subsetting,
    redefinition,
    feature_typing,
...
impl Rule {
    ...
    fn to_rowan(self) -> Option<rule_parser::Rule> {
        Some(match self {
            ...
            Rule::file => rule_parser::Rule::SysMLFile,
            
            // SysML Definitions
            Rule::part_definition => rule_parser::Rule::PartDef,
            Rule::attribute_definition => rule_parser::Rule::AttributeDef,
            Rule::item_definition => rule_parser::Rule::ItemDef,
            Rule::port_definition => rule_parser::Rule::PortDef,
            Rule::action_definition => rule_parser::Rule::ActionDef,
            Rule::state_definition => rule_parser::Rule::StateDef,
            Rule::calculation_definition => rule_parser::Rule::CalcDef,
            Rule::constraint_definition => rule_parser::Rule::ConstraintDef,
            Rule::requirement_definition => rule_parser::Rule::RequirementDef,
            Rule::connection_definition => rule_parser::Rule::ConnectionDef,
            Rule::interface_definition => rule_parser::Rule::InterfaceDef,
            Rule::allocation_definition => rule_parser::Rule::AllocationDef,
            
            // SysML Usages
            Rule::part_usage => rule_parser::Rule::PartUsage,
            Rule::attribute_usage => rule_parser::Rule::AttributeUsage,
            Rule::item_usage => rule_parser::Rule::ItemUsage,
            Rule::port_usage => rule_parser::Rule::PortUsage,
            Rule::action_usage => rule_parser::Rule::ActionUsage,
            Rule::state_usage => rule_parser::Rule::StateUsage,
            Rule::calculation_usage => rule_parser::Rule::CalcUsage,
            Rule::constraint_usage => rule_parser::Rule::ConstraintUsage,
            Rule::requirement_usage => rule_parser::Rule::RequirementUsage,
            Rule::connection_usage => rule_parser::Rule::ConnectionUsage,
            Rule::interface_usage => rule_parser::Rule::InterfaceUsage,
            Rule::allocation_usage => rule_parser::Rule::AllocationUsage,
            
            // Action body elements
            Rule::perform_action_usage => rule_parser::Rule::PerformActionUsage,
            Rule::send_action_usage => rule_parser::Rule::SendActionUsage,
            Rule::accept_action_usage => rule_parser::Rule::AcceptActionUsage,
            Rule::assign_action_usage => rule_parser::Rule::AssignActionUsage,
            Rule::if_action_usage => rule_parser::Rule::IfActionUsage,
            Rule::while_loop_action_usage => rule_parser::Rule::WhileLoopActionUsage,
            Rule::for_loop_action_usage => rule_parser::Rule::ForLoopActionUsage,
            ...
            // Fragments
            Rule::qualified_name => rule_parser::Rule::QualifiedReferenceChain,
            ...
            // Relationships
            Rule::specialization | Rule::subclassification_part => rule_parser::Rule::Specialization,
            Rule::subsetting => rule_parser::Rule::Subsetting,
            Rule::redefinition => rule_parser::Rule::Redefinition,
            Rule::feature_typing | Rule::owned_feature_typing => rule_parser::Rule::FeatureTyping,
            Rule::conjugation => rule_parser::Rule::Conjugation,
            
            // Note: owned_subsetting/owned_redefinition test just the reference portion
            // without the operator - these don't have standalone Rowan rules
            // Rule::owned_subsetting => skip
            // Rule::owned_redefinition => skip
            
            // Connectors
            Rule::connector => rule_parser::Rule::Connector,
            Rule::binding_connector => rule_parser::Rule::BindingConnector,
            Rule::binding_connector_as_usage => rule_parser::Rule::BindingConnectorAsUsage,
            Rule::succession => rule_parser::Rule::Succession,
            Rule::succession_as_usage => rule_parser::Rule::SuccessionAsUsage,
...
fn assert_round_trip(rule: Rule, input: &str, desc: &str) {
    ...
    let result = parse_rule(rowan_rule, input);
...
fn test_parse_transition_target(#[case] input: &str, #[case] desc: &str) {
    assert_parse_succeeds(Rule::transition_target, input, desc);
}
...
fn test_parse_typed_reference(#[case] input: &str, #[case] desc: &str) {
    assert_parse_succeeds(Rule::typed_reference, input, desc);
}
...
fn test_parse_action_declaration_header(#[case] input: &str, #[case] desc: &str) {
    assert_parse_succeeds(Rule::action_declaration_header, input, desc);
}
...
fn test_parse_reference_chain(#[case] input: &str, #[case] desc: &str) {
    assert_parse_succeeds(Rule::reference_chain, input, desc);
}
...
fn test_parse_succession_header(#[case] input: &str, #[case] desc: &str) {
    assert_parse_succeeds(Rule::succession_header, input, desc);
}
...
fn test_parse_package_with_constraints_and_import() {
    ...
    assert_parse_succeeds(Rule::file, input, "package with constraints and import");
}
